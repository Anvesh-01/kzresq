                            ...
                            emergencies.map((emergency) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {/* ✅ NEW: Display live ambulance location if being tracked */}
                                        ...
                                        <div className="flex gap-3">
                                            ...
                                            {emergency.status === 'acknowledged' &&
                                                emergency.assigned_hospital_name === hospitalInfo.name && (
                                                    <select
                                                        className="border-2 border-gray-300 rounded-xl px-5 py-3 text-sm text-gray-900 font-semibold focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                                                        onChange={e => dispatchAmbulance(emergency.id, e.target.value)}
                                                        defaultValue=""
                                                        disabled={isDispatching}
                                                        aria-label="Select ambulance to dispatch"
                                                    >
                                                        <option value="" disabled>
                                                            {isDispatching ? 'Dispatching...' : '🚑 Assign Ambulance'}
                                                        </option>
