...
KEN is a full-stack emergency response coordination platform that enables users to trigger an SOS alert instantly without login. The system automatically captures the user’s location, notifies nearby hospitals and police authorities, and dispatches emergency services in real time.
